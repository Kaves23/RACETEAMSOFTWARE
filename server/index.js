...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://esm.sh", "https://live.apex-timing.com", "wss://live.apex-timing.com", "https://nominatim.openstreetmap.org", "https://api.open-meteo.com", "https://api.openweathermap.org", "https://api.weatherapi.com", "https://api.openf1.org", "https://api.rainviewer.com"],
...
// Note: migrations are run on startup by `npm start` via run-migrations.js (with schema_migrations tracking)
...
const raceMonitorProxyRouter = require('./routes/race-monitor-proxy');
...
app.use('/api/race-monitor-proxy', requireAuth, raceMonitorProxyRouter);
...
app.use('/api/fin-audit',            requireAuth, require('./routes/fin-audit'));
app.use('/api/fin-cost-cap',         requireAuth, require('./routes/fin-cost-cap'));
app.use('/api/fin-forecast',         requireAuth, require('./routes/fin-forecast'));
...
app.use('/api/telemetry',    requireAuth, require('./routes/telemetry'));
